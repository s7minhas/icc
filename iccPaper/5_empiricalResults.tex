...
Within our sample a number of countries have undergone multiple ICC cases, thus we fit our PCR model in a hierarchical context in which we incorporate random effects for every country-ICC case into the linear predictor \citep{have:uttal:1994, tutz:hennevogl:1996}.\footnote{The incorporation of random effects }
