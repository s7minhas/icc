...
% To make the SM an actual regression mode, we set up a linaer regression  for each latent variable via $\widetilde{Y_{itk}} = \X_{it}\beta + \W_{it}\eta_{k} + \alpha_{i} + \epsilon_{k}$ with a category specific error term $\epsilon_{k}$.
