...
We also include country specific random effects into the linear predictor to account for potential clustering within country observations.\footnote{This generalization of the continuation ratio model was first considered by \citet{dos2000continuation} to investigate progression and remission of breast cancer.}
