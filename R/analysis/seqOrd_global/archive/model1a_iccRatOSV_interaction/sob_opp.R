...
###############################################################
## interaction between icc_rat and osv
frame$iccRat_osv = frame$icc_rat * frame$lag1_osv_rebel_cumul

# update covar vector
sobOppVars = c(sobOppVars, 'iccRat_osv')
###############################################################
...
save(mod, file=paste0(pathResults, 
...
save(modHier, file=paste0(pathResults, 
