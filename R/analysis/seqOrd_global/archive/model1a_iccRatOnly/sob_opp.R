...
frame = frame[frame$icc_rat==1,]

# remove icc_rat covariate
sobOppVars = sobOppVars[-which(sobOppVars=='icc_rat')]
###############################################################
...
save(mod, file=paste0(pathResults, 
	'sobOpp_model1a_global_iccRatOnly.rda'))
...
save(modHier, file=paste0(pathResults, 
	'sobOpp_model1a_global_hier_iccRatOnly.rda'))
###############################################################