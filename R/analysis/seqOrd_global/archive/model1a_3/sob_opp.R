...
#
sobOppVars = c(sobOppVars, 'lag1_p5_intv')
###############################################################
...
save(mod, file=paste0(pathResults, 'sobOpp_model1a_3_global.rda'))
...
save(modHier, file=paste0(pathResults, 'sobOpp_model1a_3_global_hier.rda'))
###############################################################