...
save(mod, file=paste0(pathResults, 'sobState_model1a_4_global.rda'))
...
save(modHier, file=paste0(pathResults, 'sobState_model1a_4_global_hier.rda'))
###############################################################