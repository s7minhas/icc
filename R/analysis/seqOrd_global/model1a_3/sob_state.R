...
frame$lag1_p5_intv = ifelse(
	apply(
		frame[,c('lag1_p5_gov_clean', 'lag1_p5_reb_clean')],
		1, sum)>0,
	1,0 )

#
sobStateVars = c(sobStateVars, 'lag1_p5_intv')
###############################################################
...
save(mod, file=paste0(pathResults, 'sobState_model1a_3_global.rda'))
...
save(modHier, file=paste0(pathResults, 'sobState_model1a_3_global_hier.rda'))
###############################################################