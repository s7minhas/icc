...
frame = frame[frame$lag1_civilwar==1,]

# remove icc_rat covariate
sobOppVars = sobOppVars[-which(sobOppVars=='lag1_civilwar')]
###############################################################
...
save(mod, file=paste0(pathResults, 
	'sobOpp_model1a_global_ptsCivilWarOnly.rda'))
...
save(modHier, file=paste0(pathResults, 
	'sobOpp_model1a_global_hier_ptsCivilWarOnly.rda'))
###############################################################