...
# 
sobStateVars = c(sobStateVars, 'p5')
###############################################################
...
save(mod, file=paste0(pathResults, 'sobState_model1a_1_global.rda'))
...
save(modHier, file=paste0(pathResults, 'sobState_model1a_1_global_hier.rda'))
###############################################################