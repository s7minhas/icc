...
load(paste0(pathResults, 'sobState_atop_fin.rda'))

summary(mod)

load(paste0(pathResults, 'sobOpp_atop_fin.rda'))
...
###############################################################
# switch out p5_absidealdiff with atop data
data$lag1_p5_absidealdiffMin = data$lag1_p5_defAllyAvg
###############################################################
...
save(
  mod, 
  file=paste0(pathResults, 'sobState_atop_fin.rda'))
###############################################################
