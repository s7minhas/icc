...
sobStateVars = sobStateVars[-which(sobStateVars=='icc_rat')]
###############################################################
...
save(mod, file=paste0(pathResults, 'sobState_model1a_iccRatOnly.rda'))
...
save(modHier, file=paste0(pathResults, 'sobState_model1a_hier_iccRatOnly.rda'))
###############################################################